{{-- Extenks menu from layout --}}
@extends('..layout.layout')

{{-- Put head in the layout  --}}
@section('headcontent')
    List des parentoptions
@endsection

{{-- Put sub head in the layout  --}}
...
<div class="main-card mb-3 card">
    <div class="card-body">
        <h5 class="card-title">Ajouter Une Nouvelle parentoption</h5>
        <div class="collapse" id="collapseExample123" style="">
            <form method="post" action="parentoption/create">
                {{ csrf_field() }}
                <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Nom</label>
                    <div class="col-sm-10"><input required="" name="title" id="nameVoiture" placeholder="Title" type="text" class="form-control"></div>
                </div>
...
<table id="myTable" class="mb-0 table table-striped" style="overflow: scroll">
    ...
    <tbody>
        @foreach($parentoptions as $m)
           ...
           <a  href={{"parentoption/edit/$m->id"}} title='Editer' data-toggle='tooltip'><span class='pe-7s-pen'></span></a>
           </td>
        </tr>
        ...
        $('.delete').click(function(e){
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: '/parentoption/delete/'+ delete_id,
                        data: data,
